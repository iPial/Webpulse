    ...
    return (
      <PageShell>
        ...
        <EmptyHero
          ...
          title="Add a site to start tracking trends"
          message="History needs at least one scanned site to chart month-over-month performance, Core Web Vitals, and issue counts."
          primaryCta={{ label: 'Add your first site', href: '/settings' }}
          secondaryCta={{ label: 'Back to Overview', href: '/' }}
        />
      </PageShell>
    );
  }
